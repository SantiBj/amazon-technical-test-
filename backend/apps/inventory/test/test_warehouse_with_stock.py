...
class WarehousesWithStockProductListView(APITestCase):
    def setUp(self):
        ...
        self.inventory1 = create_inventory(self.product,self.warehouse1,0)
        self.inventory2 = create_inventory(self.product,self.warehouse2,40)

    def request_view(self,id):
        return self.client.get(reverse("warehouses-with-stock-product", kwargs={'product_id': id}))
    
    def test_get_warehouses_with_stock(self):
